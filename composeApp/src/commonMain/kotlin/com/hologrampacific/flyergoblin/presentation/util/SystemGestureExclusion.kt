...
/**
 * Excludes the provided rects from Android's system gesture detection (e.g. edge back-swipe). The
 * lambda receives the canvas [IntSize] so callers can compute rects in pixel coordinates. On iOS
 * and Desktop this is a no-op.
 *
 ...
 */
expect fun Modifier.platformSystemGestureExclusion(
