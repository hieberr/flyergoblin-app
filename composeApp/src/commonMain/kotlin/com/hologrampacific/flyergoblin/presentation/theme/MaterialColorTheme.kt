...
interface MaterialColorTheme {
  fun colorScheme(mode: AppColorTheme.LightMode, contrast: AppColorTheme.Contrast): ColorScheme {
    return when (mode) {
      AppColorTheme.LightMode.Light ->
        when (contrast) {
          AppColorTheme.Contrast.Low -> lightScheme
          AppColorTheme.Contrast.Medium -> mediumContrastLightScheme
          AppColorTheme.Contrast.High -> highContrastLightScheme
        }

      AppColorTheme.LightMode.Dark ->
        when (contrast) {
          AppColorTheme.Contrast.Low -> darkScheme
          AppColorTheme.Contrast.Medium -> mediumContrastDarkScheme
          AppColorTheme.Contrast.High -> highContrastDarkScheme
        }
    }
  }
  ...
  val mediumContrastLightScheme: ColorScheme
    get() =
      lightColorScheme(
  ...
  val highContrastLightScheme: ColorScheme
    get() =
      lightColorScheme(
  ...
  val mediumContrastDarkScheme: ColorScheme
    get() =
      darkColorScheme(
  ...
  val highContrastDarkScheme: ColorScheme
    get() =
      darkColorScheme(
