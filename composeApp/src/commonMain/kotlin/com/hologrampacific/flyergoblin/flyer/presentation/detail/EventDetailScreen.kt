    ...
    if (event.artists.isNotEmpty()) {
      ClickableArtistsList(
        ...
        onArtistClick = { artistName ->
          navigator.goTo(com.hologrampacific.flyergoblin.flyer.presentation.ArtistDetail(artistName))
        },
      )
      Spacer(modifier = Modifier.height(16.dp))
    }
...
fun EventDetailScreenPreview() {
  MaterialTheme {
    EventDetailScreenContent(
      ...
      navigator = com.hologrampacific.flyergoblin.presentation.Navigator.noOpNavigator,
      onBackClick = {},
      onStartEditing = {},
      onCancelEditing = {},
      onEventChange = {},
