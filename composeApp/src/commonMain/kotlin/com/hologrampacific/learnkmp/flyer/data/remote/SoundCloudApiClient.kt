...
interface SoundCloudApiClient {
   ...
   *
   * Uses the SoundCloud `/tracks/{id}/stream` endpoint to get a direct streaming URL. Note: Not all
   * tracks are streamable off-platform (may be blocked or paywalled).
   *
