...
/**
 * Composable that initializes the URL opener with the current Android context.
 * Should be called at the top level of your Android app.
 */
@Composable
fun InitUrlOpener() {
...
actual fun openUrl(url: String) {
    val context = UrlOpenerAndroid.context ?: run {
